...
$comments_s = mysqli_real_escape_string($conn, $_POST['comments']);
 
// attempt insert query execution
//the table name and column names have to exist before execute the following query
$sql = "INSERT INTO feedback (name, email, comments) VALUES ('$name_s', '$email_s', '$comments_s')";
